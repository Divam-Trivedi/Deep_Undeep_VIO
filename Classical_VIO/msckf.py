...
class MSCKF(object):
    ...
    def imu_callback(self, imu_msg):
        ...
        if not self.is_gravity_set:
            if len(self.imu_msg_buffer) >= 100:
    ...
    def initialize_gravity_and_bias(self):
        ...
        # Compute the average of the first 100 IMU readings.
        ...
        # Set the gravity vector in the IMU state.
    ...
    def batch_imu_processing(self, time_bound):
        ...
        self.state_server.imu_state.id = IMUState.next_ids
