    ...
    def process_feature(self):
        while True:
            ...
            if feature_msg is None:
                print("qwertyuiuhygfdsxcvbhnjuhytrfdcvbnj")
                return
            ...
            if result is None:
                print("No result")
                continue
            print("Got pose:", result.cam0_pose)  # should print a 4×4 matrix
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='/Users/tvidk/Documents/Codes/CV_Project_4', 
